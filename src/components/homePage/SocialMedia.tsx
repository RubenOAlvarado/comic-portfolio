const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/RubenOAlvarado',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/ruben-alvarado-molina-9020010',
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'X (Twitter)',
      url: 'https://x.com/RubenOAlvarado',
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      url: 'https://instagram.com/alvaradorubo',
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
